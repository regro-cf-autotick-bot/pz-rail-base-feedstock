...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pz-rail-base-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pz-rail-base-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pz-rail-base
# for installing globally
pixi global install pz-rail-base
```
...
It is possible to list all of the versions of `pz-rail-base` available on your platform:
...
```
pixi search pz-rail-base --channel conda-forge
```
